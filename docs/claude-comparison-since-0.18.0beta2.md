...
flowchart TD
    ...
    I --> J{"Refresh status"}
    J -- "200" --> K["Save refreshed creds to AgentsBar keychain cache + memory"]
...
```mermaid
flowchart TD
    A["load(...)"] --> B["Environment token (AGENTSBAR_CLAUDE_OAUTH_TOKEN)"]
    B -->|miss| C["Memory cache (valid + unexpired)"]
    C -->|miss| D["AgentsBar keychain cache: com.steipete.agentsbar.cache/oauth.claude"]
...
- `/Users/ratulsarna/Developer/staipete/AgentsBar/Sources/AgentsBarCore/Providers/Claude/ClaudeUsageFetcher.swift`
- `/Users/ratulsarna/Developer/staipete/AgentsBar/Sources/AgentsBarCore/Providers/Claude/ClaudeProviderDescriptor.swift`
- `/Users/ratulsarna/Developer/staipete/AgentsBar/Sources/AgentsBarCore/Providers/Claude/ClaudeOAuth/ClaudeOAuthCredentials.swift`
- `/Users/ratulsarna/Developer/staipete/AgentsBar/Sources/AgentsBarCore/Providers/Claude/ClaudeOAuth/ClaudeOAuthKeychainAccessGate.swift`
- `/Users/ratulsarna/Developer/staipete/AgentsBar/Sources/AgentsBarCore/Providers/Claude/ClaudeOAuth/ClaudeOAuthRefreshFailureGate.swift`
- `/Users/ratulsarna/Developer/staipete/AgentsBar/Sources/AgentsBarCore/KeychainAccessPreflight.swift`
- `/Users/ratulsarna/Developer/staipete/AgentsBar/Sources/AgentsBarCore/KeychainNoUIQuery.swift`
- `/Users/ratulsarna/Developer/staipete/AgentsBar/Sources/AgentsBarCore/BrowserCookieImportOrder.swift`
- `/Users/ratulsarna/Developer/staipete/AgentsBar/Sources/AgentsBarCore/BrowserCookieAccessGate.swift`
