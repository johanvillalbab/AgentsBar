---
summary: "Convert macOS .icon bundles to AgentsBar .icns via Scripts/build_icon.sh and ictool."
read_when:
  - Updating the AgentsBar app icon or asset pipeline
...
## Script
`Scripts/build_icon.sh ICON.icon AgentsBar [outdir]`
