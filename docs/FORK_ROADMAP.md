...
# AgentsBar Fork Roadmap

This document outlines the development roadmap for the AgentsBar fork maintained by Brandon Charleson.
...
1. **Replace print() with proper logging**
   - Use `AgentsBarLog.logger("augment")` throughout
...
**Files to Modify:**
- `Sources/AgentsBarCore/Providers/Augment/AugmentStatusProbe.swift`
- `Sources/AgentsBarCore/Providers/Augment/AugmentSessionKeepalive.swift`
- `Sources/AgentsBar/UsageStore.swift` (debug pane)
...
**Files to Create:**
- `Sources/AgentsBarCore/AccountManager.swift`
- `Sources/AgentsBarCore/Providers/Augment/AugmentAccountManager.swift`
- `Sources/AgentsBar/AccountSwitcherView.swift`
