...
# AgentsBar Fork - Quick Start Guide
...
**Fork Repository:** https://github.com/topoffunnel/AgentsBar
...
### Source Code
- `Sources/AgentsBar/` - Swift 6 menu bar app
- `Sources/AgentsBarCore/` - Core logic, providers, utilities
- `Sources/AgentsBarCore/Providers/Augment/` - Augment provider implementation
- `Tests/AgentsBarTests/` - XCTest coverage
...
1. Enable debug logging: `export AGENTSBAR_LOG_LEVEL=debug`
2. Check Console.app for "com.steipete.agentsbar"
...
- If you still see prompts, check `Sources/AgentsBarCore/Keychain/`
...
1. Start with `Sources/AgentsBar/AgentsbarApp.swift` - App entry point
2. Review `Sources/AgentsBarCore/UsageStore.swift` - Main state management
3. Check `Sources/AgentsBarCore/Providers/` - Provider implementations
...
4. Submit PR to `topoffunnel/AgentsBar`

### To Upstream
1. Check if feature benefits all users
2. Create PR to `johanvillalbab/agentsbar`
...
- GitHub Issues: https://github.com/topoffunnel/AgentsBar/issues
- Email: [your-email]@topoffunnel.com

### Upstream Issues
- GitHub Issues: https://github.com/johanvillalbab/agentsbar/issues
