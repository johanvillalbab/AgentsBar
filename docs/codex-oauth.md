...
> Replicate Codex's direct OAuth token usage in AgentsBar instead of calling the CLI.

## Background

Currently, AgentsBar fetches Codex usage by:
...
- Command: `AgentsBarCLI usage --provider codex --source oauth --json --pretty`
...
|------|----------|---------|
| `CodexOAuthCredentials.swift` | `Sources/AgentsBarCore/Providers/Codex/CodexOAuth/` | Token storage model + loader |
| `CodexOAuthUsageFetcher.swift` | `Sources/AgentsBarCore/Providers/Codex/CodexOAuth/` | API client for usage endpoint |
| `CodexTokenRefresher.swift` | `Sources/AgentsBarCore/Providers/Codex/CodexOAuth/` | Token refresh logic |
...
public enum CodexOAuthUsageFetcher {
    ...
    public static func fetchUsage(
        ...
        request.setValue("AgentsBar", forHTTPHeaderField: "User-Agent")
...
2. Run AgentsBar with debug logging enabled
