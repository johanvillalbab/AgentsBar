...
The checked-out source tree is not the main cause of AgentsBar's clone size. At commit `61ff9320`, tracked files total
...
| `Quotio/` | 23,141,837 |
| `AgentsBar 2.app/` | 7,088,125 |
| `AgentsBar-0.2.2.zip` | 2,296,323 |
...
```bash
git clone --filter=blob:none https://github.com/johanvillalbab/agentsbar.git
git clone --depth=1 https://github.com/johanvillalbab/agentsbar.git
```
