...
read_when:
  - Investigating AgentsBar CPU or energy regressions
  - Changing Codex CLI PTY probe timing or retry behavior
  - Reviewing issue 139 performance evidence
---

# AgentsBar Issue #139 Performance/Energy Simulation Report

Date: 2026-02-19
Workspace: /Users/michalkrsik/windsurf_project_folder/AgentsBar
Issue: https://github.com/johanvillalbab/agentsbar/issues/139
...
Artifacts:
- /tmp/agentsbar_perf_sim/results_20260219_111607
...
Artifacts:
- /tmp/agentsbar_perf_sim/energy2_results_20260219_112350
...
- These were controlled simulations, not a full end-user UI replay of `AgentsBar.app` with all real auth/cookie/account paths.
