...
1) **CLI command** (primary and only strategy)
   ...
   - AgentsBar tries ordinary stdout/stderr pipes first for current Kiro CLI releases. Incomplete or unusable
   ...
   - Output is ANSI-decorated; AgentsBar strips escape sequences before parsing.
...
- `Sources/AgentsBarCore/Providers/Kiro/KiroProviderDescriptor.swift`
- `Sources/AgentsBarCore/Providers/Kiro/KiroStatusProbe.swift`
- `Sources/AgentsBar/Providers/Kiro/KiroProviderImplementation.swift`
