...
const productName = "AgentsBar";
const source = "https://github.com/johanvillalbab/agentsbar";
...
const productDescription =
  ...
  "AgentsBar shows AI coding-provider usage limits in the macOS menu bar.";
