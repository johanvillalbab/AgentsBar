...
PLIST_SCRIPT=$(mktemp "${TMPDIR:-/tmp}/agentsbar-package-info-plist-script.XXXXXX")
TEMP_DIR=$(mktemp -d "${TMPDIR:-/tmp}/agentsbar-package-info-plist.XXXXXX")
...
BUNDLE_ID=com.steipete.agentsbar.test
...
assert declarations == [{
    "UTTypeIdentifier": "com.steipete.agentsbar.menu-layout-item",
    "UTTypeDescription": "AgentsBar menu bar layout token",
