...
FUNCTIONS_FILE=$(mktemp "${TMPDIR:-/tmp}/agentsbar-package-strip-functions.XXXXXX")
TEMP_DIR=$(mktemp -d "${TMPDIR:-/tmp}/agentsbar-package-strip.XXXXXX")
