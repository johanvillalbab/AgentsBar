...
/// Replay adapter for the same canonical policy core used by the AgentsBar app.
...
/// compare the adaptive policy against the flat refresh frequencies AgentsBar also offers
