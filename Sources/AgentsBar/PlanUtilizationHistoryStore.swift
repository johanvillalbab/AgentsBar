...
struct PlanUtilizationHistoryBuckets: Equatable, Sendable {
    ...
    private static let unscopedIdentityKey = "__agentsbar_unscoped__"
    private static let invalidatedIdentity = "__agentsbar_invalidated__"
...
struct PlanUtilizationHistoryStore: Sendable {
    ...
    private static func defaultDirectoryURL() -> URL? {
        ...
        let dir = root.appendingPathComponent("com.steipete.agentsbar", isDirectory: true)
