...
extension SettingsStore {
    ...
    func reloadTokenAccounts() {
        let log = AgentsBarLog.logger(LogCategories.tokenAccounts)
    ...
    func openTokenAccountsFile() {
        do {
            ...
            AgentsBarLog.logger(LogCategories.tokenAccounts).error("Failed to persist config: \(error)")
            return
        }
        ...
        removedCredentials: AntigravityOAuthCredentials)
    {
        do {
            ...
            AgentsBarLog.logger(LogCategories.tokenAccounts).warning(
