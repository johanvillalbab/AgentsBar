...
enum ProviderBrandIcon {
    ...
    private static let resourceBundle: Bundle? = {
        ...
        // SwiftPM creates a AgentsBar_AgentsBar.bundle for resources in the AgentsBar target.
        if let bundleURL = Bundle.main.url(forResource: "AgentsBar_AgentsBar", withExtension: "bundle"),
