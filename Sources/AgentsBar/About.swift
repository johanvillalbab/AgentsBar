...
func showAbout() {
    ...
    let buildTimestamp = Bundle.main.object(forInfoDictionaryKey: "AgentsBarBuildTimestamp") as? String
    let gitCommit = Bundle.main.object(forInfoDictionaryKey: "AgentsBarGitCommit") as? String
    ...
    credits.append(makeLink("GitHub", urlString: "https://github.com/johanvillalbab/agentsbar"))
    credits.append(separator)
    credits.append(makeLink("Website", urlString: "https://agentsbar.app"))
    credits.append(separator)
