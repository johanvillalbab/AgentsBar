...
struct AboutPane: View {
    ...
    private var buildTimestamp: String? {
        guard let raw = Bundle.main.object(forInfoDictionaryKey: "AgentsBarBuildTimestamp") as? String else { return nil }
        ...
        Form {
            ...
            Section {
                AboutLinkRow(
                    ...
                    title: L("link_github"),
                    url: "https://github.com/johanvillalbab/agentsbar")
    ...
    private func openProjectHome() {
        guard let url = URL(string: "https://github.com/johanvillalbab/agentsbar") else { return }
