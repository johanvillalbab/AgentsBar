    ...
    static func live() -> Self {
        Self(
            notification: {
                ...
                NotificationCenter.default.post(name: .agentsbarOpenSettings, object: request)
...
struct HiddenWindowView: View {
    ...
    var body: some View {
        Color.clear
            ...
            .onReceive(NotificationCenter.default.publisher(for: .agentsbarOpenSettings)) { notification in
...
final class KeepaliveWindowConfiguratorView: NSView {
    ...
    override func viewDidMoveToWindow() {
        ...
        window.identifier = NSUserInterfaceItemIdentifier("AgentsBarLifecycleKeepalive")
