...
struct AgentsBarUsageWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: AgentsBarWidgetEntry
...
struct AgentsBarHistoryWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: AgentsBarWidgetEntry
...
struct AgentsBarCompactWidgetView: View {
...
struct AgentsBarSwitcherWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: AgentsBarSwitcherEntry
