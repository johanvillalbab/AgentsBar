...
enum KeychainTestSafety {
    static let suppressAccessEnvironmentKey = "AGENTSBAR_SUPPRESS_TEST_KEYCHAIN_ACCESS"
    static let allowAccessEnvironmentKey = "AGENTSBAR_ALLOW_TEST_KEYCHAIN_ACCESS"
