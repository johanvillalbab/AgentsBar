...
public enum AgentsBarLog {
    ...
    public static func logger(_ category: String) -> AgentsBarLogger {
        let logger = Logger(label: "com.steipete.agentsbar.\(category)")
        return AgentsBarLogger(isEnabled: { level in
...
public struct AgentsBarLogger: Sendable {
    private let isEnabled: @Sendable (AgentsBarLog.Level) -> Bool
    private let logFn: @Sendable (AgentsBarLog.Level, String, [String: String]?) -> Void

    fileprivate init(
        isEnabled: @escaping @Sendable (AgentsBarLog.Level) -> Bool,
        log: @escaping @Sendable (AgentsBarLog.Level, String, [String: String]?) -> Void)
    {
    ...
    init(
        minimumLevel: AgentsBarLog.Level,
        log: @escaping @Sendable (AgentsBarLog.Level, String, [String: String]?) -> Void)
    {
