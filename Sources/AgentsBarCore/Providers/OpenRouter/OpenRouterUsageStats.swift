...
public struct OpenRouterUsageFetcher: Sendable {
    private static let log = AgentsBarLog.logger(LogCategories.openRouterUsage)
    ...
    private static let debugFullErrorBodiesEnvKey = "AGENTSBAR_DEBUG_OPENROUTER_ERROR_BODIES"
    private static let httpRefererEnvKey = "OPENROUTER_HTTP_REFERER"
    private static let clientTitleEnvKey = "OPENROUTER_X_TITLE"
    private static let defaultClientTitle = "AgentsBar"
