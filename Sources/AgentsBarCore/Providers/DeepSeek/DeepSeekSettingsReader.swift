...
public struct DeepSeekSettingsReader: Sendable {
    ...
    public static let profileIDEnvironmentKey = "AGENTSBAR_DEEPSEEK_PROFILE_ID"
    public static let profileScopeEnvironmentKey = "AGENTSBAR_DEEPSEEK_PROFILE_SCOPE"
    ...
    public static func profileScope(selectedTokenAccountID: UUID?, apiKey: String?) -> String? {
        ...
        let input = "com.steipete.agentsbar.deepseek-profile-scope.v1\0\(accountScope)\0\(apiKey)"
