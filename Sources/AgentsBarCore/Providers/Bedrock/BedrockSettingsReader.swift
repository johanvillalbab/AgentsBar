...
public enum BedrockSettingsReader {
    ...
    public static let budgetKey = "AGENTSBAR_BEDROCK_BUDGET"
    public static let apiURLKey = "AGENTSBAR_BEDROCK_API_URL"
    public static let cloudWatchAPIURLKey = "AGENTSBAR_BEDROCK_CLOUDWATCH_API_URL"
    public static let profileKey = "AWS_PROFILE"
    public static let authModeKey = "AGENTSBAR_BEDROCK_AUTH_MODE"
