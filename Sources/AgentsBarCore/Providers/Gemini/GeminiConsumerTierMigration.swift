...
public enum GeminiConsumerTierMigration {
    ...
    Enable AgentsBar's Antigravity provider, sign in to Antigravity or run `agy`, then refresh.
    """
    ...
    accounts blocked by the June 2026 Gemini CLI shutdown should use AgentsBar's Antigravity \
