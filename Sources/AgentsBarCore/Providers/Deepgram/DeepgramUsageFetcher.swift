...
public enum DeepgramUsageError: LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        switch self {
        case .missingAPIKey:
            "Missing Deepgram API key. Set apiKey in ~/.config/agentsbar/config.json or DEEPGRAM_API_KEY."
...
public struct DeepgramUsageFetcher: Sendable {
    ...
    private static let log = AgentsBarLog.logger(LogCategories.deepgramUsage)
