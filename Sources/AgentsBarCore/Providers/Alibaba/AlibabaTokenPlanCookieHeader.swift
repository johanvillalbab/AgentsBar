...
struct AlibabaTokenPlanCookieHeaders {
    private static let cachedAPIHeaderName = "__agentsbar_alibaba_token_plan_api"
    private static let cachedDashboardHeaderName = "__agentsbar_alibaba_token_plan_dashboard"
