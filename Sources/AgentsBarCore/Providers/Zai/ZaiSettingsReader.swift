...
public struct ZaiSettingsReader: Sendable {
    private static let log = AgentsBarLog.logger(LogCategories.zaiSettings)
...
public enum ZaiSettingsError: LocalizedError, Sendable, Equatable {
    ...
    public var errorDescription: String? {
        switch self {
        case .missingToken:
            "z.ai API token not found. Set apiKey in ~/.config/agentsbar/config.json or Z_AI_API_KEY."
