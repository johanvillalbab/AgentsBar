...
public enum AgentsBarConfigIssueSeverity: String, Codable, Sendable {
    case warning
    case error
}

public struct AgentsBarConfigIssue: Codable, Sendable, Equatable {
    public let severity: AgentsBarConfigIssueSeverity
    ...
    public init(
        severity: AgentsBarConfigIssueSeverity,
...
public enum AgentsBarConfigValidator {
    ...
    public static func validate(_ config: AgentsBarConfig) -> [AgentsBarConfigIssue] {
        var issues: [AgentsBarConfigIssue] = []

        if config.version != AgentsBarConfig.currentVersion {
            issues.append(AgentsBarConfigIssue(
                severity: .error,
                provider: nil,
                field: "version",
    ...
    private static func validateHooks(_ hooks: HooksConfig?, issues: inout [AgentsBarConfigIssue]) {
    ...
    private static func hookIssue(field: String, code: String, message: String) -> AgentsBarConfigIssue {
        AgentsBarConfigIssue(
            severity: .error,
            provider: nil,
            field: field,
            code: code,
    ...
    private static func validateProvider(_ entry: ProviderConfig, issues: inout [AgentsBarConfigIssue]) {
    ...
    private static func validateSecretKey(_ entry: ProviderConfig, issues: inout [AgentsBarConfigIssue]) {
    ...
    private static func validateSub2APIBaseURL(_ entry: ProviderConfig, issues: inout [AgentsBarConfigIssue]) {
    ...
    private static func validateZaiTeamContext(_ entry: ProviderConfig, issues: inout [AgentsBarConfigIssue]) {
    ...
    private static func zaiMissingTeamContextIssue(field: String) -> AgentsBarConfigIssue {
        AgentsBarConfigIssue(
            severity: .warning,
            provider: .zai,
            field: field,
    ...
    private static func validateRegion(_ entry: ProviderConfig, issues: inout [AgentsBarConfigIssue]) {
        let provider = entry.id
    ...
    private static func validateKnownRegion(
        ...
        isValid: Bool,
        displayName: String,
        issues: inout [AgentsBarConfigIssue])
    {
