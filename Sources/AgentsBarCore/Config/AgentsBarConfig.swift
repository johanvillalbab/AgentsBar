...
public struct AgentsBarConfig: Codable, Sendable {
    public static let currentVersion = 1

    private static let log = AgentsBarLog.logger(LogCategories.configStore)
    ...
    public static func makeDefault(
        metadata: [UsageProvider: ProviderMetadata] = ProviderDescriptorRegistry.metadata) -> AgentsBarConfig
    {
        ...
        return AgentsBarConfig(version: Self.currentVersion, providers: providers)
    }
