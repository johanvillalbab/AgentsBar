...
let openAIDashboardScrapeScript = """
    ...
    (() => {
      ...
      const usageBreakdownJSON = (() => {
        try {
          if (window.__agentsbarUsageBreakdownJSON) return window.__agentsbarUsageBreakdownJSON;
          ...
          window.__agentsbarUsageBreakdownJSON = json;
          window.__agentsbarUsageBreakdownDebug = json ? null : JSON.stringify(debug);
          return json;
        } catch {
          return null;
        }
      ...
      const usageBreakdownDebug = (() => {
        try {
          return window.__agentsbarUsageBreakdownDebug || null;
        } catch {
          return null;
        }
      })();
      ...
      try {
        ...
        if (header) {
          ...
          if (rows.length === 0 && !window.__agentsbarDidScrollToCredits) {
            window.__agentsbarDidScrollToCredits = true;
        ...
        } else if (rows.length === 0 && !window.__agentsbarDidScrollToCredits && scrollHeight > viewportHeight * 1.5) {
          rows = allTableRows();
          if (rows.length > 0) {
            creditsHeaderPresent = true;
        ...
        if (rows.length === 0 && !window.__agentsbarDidScrollToCredits && scrollHeight > viewportHeight * 1.5) {
