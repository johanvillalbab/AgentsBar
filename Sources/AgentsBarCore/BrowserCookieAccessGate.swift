...
public enum BrowserCookieAccessGate {
    ...
    private static let log = AgentsBarLog.logger(LogCategories.browserCookieGate)
    ...
    static let allowTestCookieAccessEnvironmentKey = "AGENTSBAR_ALLOW_TEST_BROWSER_COOKIE_ACCESS"
...
extension BrowserCookieClient {
    public func agentsBarStores(for browser: Browser) throws -> [BrowserCookieStore] {
