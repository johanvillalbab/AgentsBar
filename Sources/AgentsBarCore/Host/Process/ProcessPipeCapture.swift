...
package final class ProcessPipeCapture: @unchecked Sendable {
    ...
    #if os(Linux)
    private let readerQueue = DispatchQueue(label: "com.steipete.AgentsBar.process-pipe-capture.reader")
    private let callbackQueue = DispatchQueue(label: "com.steipete.AgentsBar.process-pipe-capture.callback")
