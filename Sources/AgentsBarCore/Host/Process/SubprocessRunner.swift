...
public enum SubprocessRunnerError: LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        ...
        case let .binaryNotFound(binary):
            return "Missing CLI '\(binary)'. Install it and restart AgentsBar."
...
public enum SubprocessRunner {
    private static let log = AgentsBarLog.logger(LogCategories.subprocess)
    private static let timeoutQueue = DispatchQueue(
        label: "com.steipete.agentsbar.subprocess.timeout",
        qos: .userInitiated,
