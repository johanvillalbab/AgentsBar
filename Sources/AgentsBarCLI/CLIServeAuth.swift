...
enum CLIServeStartupError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case let .missingDashboardToken(host):
            "--dashboard-token (or AGENTSBAR_DASHBOARD_TOKEN) is required for non-loopback --host '\(host)'."
...
extension AgentsBarCLI {
    /// Startup validation for `agentsbar serve` binding and dashboard-token flags.
