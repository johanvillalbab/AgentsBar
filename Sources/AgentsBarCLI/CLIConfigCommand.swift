...
extension AgentsBarCLI {
    ...
    static func runConfigSetProviderEnabled(_ values: ParsedValues, enabled: Bool) {
        ...
        let store = AgentsBarConfigStore()
    ...
    static func configSettingAPIKey(
        ...
        apiKey: String,
        enableProvider: Bool,
        accountOptions: ConfigAPIKeyAccountOptions? = nil) -> AgentsBarConfig
    {
    ...
    static func configProviderStatuses(_ config: AgentsBarConfig) -> [ConfigProviderStatusResult] {
