...
///
/// 32 provider settings readers (plus `AgentsBarConfig` and `CLIConfigCommand`) share a
...
/// values in `~/.config/agentsbar/config.json`, both of which are user-controllable.
///
