...
struct QoderUsageFetcherTests {
    ...
    /// Fixture shape from johanvillalbab/agentsbar#1590 (camelCase browser response).
    ...
    /// Fixture shape from johanvillalbab/agentsbar#1590 (snake_case browser response).
