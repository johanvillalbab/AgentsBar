...
struct AppGroupSupportTests {
    ...
    func `app group identifiers use resolved team-prefixed release and debug variants`() {
        #expect(
            AppGroupSupport.currentGroupID(teamID: "Y5PE65HELJ", bundleID: "com.steipete.agentsbar")
                == "Y5PE65HELJ.com.steipete.agentsbar")
        #expect(
            AppGroupSupport.currentGroupID(teamID: "ABCDE12345", bundleID: "com.steipete.agentsbar.debug")
                == "ABCDE12345.com.steipete.agentsbar.debug")
        #expect(
            AppGroupSupport.legacyTeamPrefixedGroupID(teamID: "Y5PE65HELJ", bundleID: "com.steipete.agentsbar")
                == "Y5PE65HELJ.com.steipete.codexbar")
        #expect(
            AppGroupSupport.legacyTeamPrefixedGroupID(teamID: "ABCDE12345", bundleID: "com.steipete.agentsbar.debug")
                == "ABCDE12345.com.steipete.codexbar.debug")
        #expect(
            AppGroupSupport.legacyGroupID(for: "com.steipete.agentsbar")
                == "group.com.steipete.codexbar")
        #expect(
            AppGroupSupport.legacyGroupID(for: "com.steipete.agentsbar.debug")
    ...
    func `legacy migration copies snapshot once`() throws {
        ...
        let result = AppGroupSupport.migrateLegacyDataIfNeeded(
            bundleID: "com.steipete.agentsbar",
