    ...
    func `fetch usage sets credits timeout and client headers`() async throws {
        ...
        OpenRouterStubURLProtocol.handler = { request in
            ...
            case "/api/v1/credits":
                ...
                #expect(request.value(forHTTPHeaderField: "HTTP-Referer") == "https://agentsbar.example")
                #expect(request.value(forHTTPHeaderField: "X-Title") == "AgentsBar QA")
        ...
        let usage = try await OpenRouterUsageFetcher.fetchUsage(
            ...
            environment: [
                ...
                "OPENROUTER_HTTP_REFERER": " https://agentsbar.example ",
                "OPENROUTER_X_TITLE": "AgentsBar QA",
            ])
