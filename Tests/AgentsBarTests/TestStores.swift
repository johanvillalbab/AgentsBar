...
func testConfigStore(suiteName: String, reset: Bool = true) -> AgentsBarConfigStore {
    ...
    return AgentsBarConfigStore(fileURL: url)
}
...
func testSettingsStore(
    ...
    config: AgentsBarConfig? = nil) -> SettingsStore
{
