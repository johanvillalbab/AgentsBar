...
struct StatusItemBalanceDisplayTests {
    ...
    func `debug bundle identity updates status item accessibility`() {
        #expect(StatusItemController.isDebugApp(bundleIdentifier: "com.steipete.agentsbar.debug"))
        #expect(!StatusItemController.isDebugApp(bundleIdentifier: "com.steipete.agentsbar"))
        #expect(!StatusItemController.isDebugApp(bundleIdentifier: nil))
        #expect(StatusItemController.statusItemAccessibilityTitle(isDebugApp: true) == "AgentsBar Debug")
        #expect(StatusItemController.statusItemAccessibilityTitle(isDebugApp: false) == "AgentsBar")
    }
