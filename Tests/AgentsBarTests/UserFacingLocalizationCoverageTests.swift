...
struct UserFacingLocalizationCoverageTests {
    ...
    func `selected user-facing UI surfaces avoid raw English literals`() throws {
        ...
        let forbiddenMarkersByFile: [String: [String]] = [
            "Sources/AgentsBar/CostHistoryChartMenuView.swift": [
                ".value(\"Day\"",
                ".value(\"Cost\"",
                ".value(\"Cap start\"",
                ".value(\"Cap end\"",
            ],
            "Sources/AgentsBar/CreditsHistoryChartMenuView.swift": [
                ".value(\"Day\"",
                ".value(\"Credits used\"",
                ".value(\"Cap start\"",
                ".value(\"Cap end\"",
            ...
            "Sources/AgentsBar/PlanUtilizationHistoryChartMenuView.swift": [
                ".value(\"Series\"",
            ...
            "Sources/AgentsBar/Providers/JetBrains/JetBrainsLoginFlow.swift": [
                "                \"Install a JetBrains IDE with AI Assistant enabled, then refresh AgentsBar.\",",
                "                \"Alternatively, set a custom path in Settings.\",",
                "title: \"No JetBrains IDE detected\"",
            ],
            "Sources/AgentsBar/PreferencesCodexAccountsSection.swift": [
                "?? \"No system account\"",
                ...
                "Text(\"Active\")",
                "Text(\"Choose which Codex account AgentsBar should follow.\")",
                "Text(\"Account\")",
            ...
            "Sources/AgentsBar/PreferencesProviderErrorView.swift": [
                ".help(\"Copy error\")",
            ],
            "Sources/AgentsBar/PreferencesSpendDashboardPane.swift": [
                "Text(\"Model breakdown unavailable\")",
            ],
            "Sources/AgentsBar/PreferencesProviderSettingsRows.swift": [
                "Text(self.title)",
            ...
            "Sources/AgentsBar/PreferencesSidebar.swift": [
                "\"Disabled —",
                ".accessibilityLabel(\"Sort",
            ],
            "Sources/AgentsBar/StatusItemController+CostMenuCard.swift": [
                "static let costMenuTitle",
            ],
            "Sources/AgentsBar/UsageBreakdownChartMenuView.swift": [
                ".value(\"Day\"",
                ".value(\"Credits used\"",
                ".value(\"Service\"",
                ".value(\"Cap start\"",
    ...
    func `spend dashboard model breakdown state stays precise and localized`() throws {
        ...
        let source = try String(
            contentsOf: root.appendingPathComponent("Sources/AgentsBar/PreferencesSpendDashboardPane.swift"),
            encoding: .utf8)
    ...
    func `spend dashboard chart keeps validated points when aggregate total is unavailable`() {
        ...
        AgentsBarLocalizationOverride.$appLanguage.withValue("en") {
