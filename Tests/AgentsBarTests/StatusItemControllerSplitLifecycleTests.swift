...
struct StatusItemControllerSplitLifecycleTests {
    ...
    func `merged mode removes split provider status items`() throws {
        ...
        #expect(controller.expectedVisibleStatusItemAutosaveNames == ["agentsbar-codex", "agentsbar-claude"])
        ...
        #expect(controller.expectedVisibleStatusItemAutosaveNames == ["agentsbar-merged"])
    }
    ...
    func `status items publish stable manager identity`() throws {
        ...
        #expect(controller.statusItem.autosaveName == "agentsbar-merged")
        #expect(controller.statusItems[.codex]?.autosaveName == "agentsbar-codex")
        #expect(controller.statusItems[.claude]?.autosaveName == "agentsbar-claude")
        #expect(controller.statusItem.button?.accessibilityIdentifier() == "AgentsBar.StatusItem")
        #expect(codexButton.accessibilityIdentifier() == "AgentsBar.StatusItem.codex")
        #expect(claudeButton.accessibilityIdentifier() == "AgentsBar.StatusItem.claude")
        #expect(controller.statusItem.button?.accessibilityTitle() == "AgentsBar")
        #expect(codexButton.accessibilityTitle() == "AgentsBar")
        #expect(claudeButton.accessibilityTitle() == "AgentsBar")
    ...
    func `status item identity returns stable autosave names`() {
        #expect(StatusItemController.StatusItemIdentity.merged.autosaveName == "agentsbar-merged")
        #expect(StatusItemController.StatusItemIdentity.provider(.codex).autosaveName == "agentsbar-codex")
        #expect(StatusItemController.StatusItemIdentity.provider(.claude).autosaveName == "agentsbar-claude")
    }
    ...
    func `status item placement preflight leaves fresh install placement unset`() throws {
        ...
        let key = MenuBarStatusItemPlacementPreflight.preferredPositionKey(autosaveName: "agentsbar-merged")

        #expect(!MenuBarStatusItemPlacementPreflight.prepare(defaults: defaults, autosaveName: "agentsbar-merged"))
    ...
    func `status item placement preflight clears provider matching suspicious legacy placement`() throws {
        ...
        defaults.set(42, forKey: "NSStatusItem Preferred Position Item-0")
        defaults.set(11298, forKey: "NSStatusItem Preferred Position Item-1")
        let key = MenuBarStatusItemPlacementPreflight.preferredPositionKey(autosaveName: "agentsbar-codex")

        #expect(MenuBarStatusItemPlacementPreflight.prepare(
            defaults: defaults,
            autosaveName: "agentsbar-codex",
    ...
    func `status item defaults repair removes stale hidden Control Center keys once`() throws {
        ...
        defaults.set(false, forKey: "NSStatusItem VisibleCC agentsbar-merged")
        ...
        #expect(repairedKeys == [
            ...
            "NSStatusItem VisibleCC agentsbar-merged",
        ...
        #expect(defaults.object(forKey: "NSStatusItem VisibleCC agentsbar-merged") == nil)
    ...
    func `status item visibility default distinguishes enabled disabled and unset`() throws {
        ...
        let defaults = try #require(UserDefaults(suiteName: suite))
        defaults.removePersistentDomain(forName: suite)
        defaults.set(true, forKey: "NSStatusItem VisibleCC agentsbar-merged")
        defaults.set(false, forKey: "NSStatusItem VisibleCC agentsbar-claude")
        defer { defaults.removePersistentDomain(forName: suite) }

        #expect(MenuBarStatusItemDefaultsRepair.visibilityDefault(
            defaults: defaults,
            autosaveName: "agentsbar-merged") == true)
        #expect(MenuBarStatusItemDefaultsRepair.visibilityDefault(
            defaults: defaults,
            autosaveName: "agentsbar-claude") == false)
        #expect(MenuBarStatusItemDefaultsRepair.visibilityDefault(
            defaults: defaults,
            autosaveName: "agentsbar-codex") == nil)
    }
    ...
    func `non destructive visibility refresh preserves split provider status items`() throws {
        ...
        #expect(newCodexItem.autosaveName == "agentsbar-codex")
        #expect(newCodexItem.button?.accessibilityIdentifier() == "AgentsBar.StatusItem.codex")
    }
    ...
    func `visibility recovery renders replacement merged status item`() throws {
        ...
        #expect(mergedButton.image != nil)
        #expect(controller.statusItem.autosaveName == "agentsbar-merged")
        #expect(mergedButton.accessibilityIdentifier() == "AgentsBar.StatusItem")
    }
}
