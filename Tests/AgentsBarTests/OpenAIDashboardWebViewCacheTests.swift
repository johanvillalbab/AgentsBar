...
struct OpenAIDashboardWebViewCacheTests {
    ...
    func `Reused page reset clears one shot scraper globals`() async throws {
        ...
        _ = try await lease.webView.evaluateJavaScript(
            ...
            window.__agentsbarUsageBreakdownJSON = '[{"day":"2026-04-19"}]';
            window.__agentsbarUsageBreakdownDebug = 'debug';
            true;
            """)
        ...
        let reset = try await lease.webView.evaluateJavaScript(
            """
            typeof window.__agentsbarDidScrollToCredits === 'undefined' &&
            typeof window.__agentsbarUsageBreakdownJSON === 'undefined' &&
            typeof window.__agentsbarUsageBreakdownDebug === 'undefined'
            """) as? Bool
